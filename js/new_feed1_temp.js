...
// div형태로 dropzone 구현(form형식도 블로그에 있다.)
Dropzone.autoDiscover = false;  // deprecated 된 옵션. false로 해놓는걸 공식문서에서 명시
   ...
   thumbnailHeight: 128, // Upload icon size
   thumbnailWidth: 128, // Upload icon size
   ...
   init: function () {
      ...
      // 서버에 제출 submit 버튼 이벤트 등록 (#Next(현재는 임시로 class="btn")를 누르면 이벤트 발생하게 해놨음)
